Matrizlog(decl a, decl b, decl Theta, decl matriz, decl ind, decl lc, decl dados){
decl j,i,auxa;
decl aux,un,prob;
...
if(lc==1){
	...
	prob=probn(a[aux]*Theta-b[aux]*un)-0.00000001;
	...
	prob=probn(a*Theta[aux]-b*un)-0.00000001;

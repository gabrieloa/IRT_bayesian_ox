...
MetropolisTheta(const a,const b,const Theta, const Resp, const Z, const Tau,const Matriz) {
...
prob=probn(a*thetaprop-b*un)-0.00000001;
...
Vero_prop=sumc((1-Z).*M);

Vero_atual=sumc((1-Z).*Matriz);

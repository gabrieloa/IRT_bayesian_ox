MetropolisAB(const a,const b,const Theta, const Resp, const Z, const Ma, const Sa, const Mb, const Sb, const Taua, const Taub,const Matriz){
...
prob=probn(aprop*Theta-bprop*un)-0.00000001;
...
Vero_prop=sumr((1-Z).*M);

Vero_atual=sumr((1-Z).*Matriz);

...
ranseed(111);
	...
	c0= 0.05 + 0.1*ranu(NumItem, 1);														// Cria vetor Coluna com parâmetro de adivinhação	  // COLUNA
	d0= 0.05*ranu(NumItem,1);
	Theta0 = rann(1, NumStud);																// Cria vetor Linha com parâmetro habilidade	      // LINHA
	Resp = BancoDeDados(a0, b0, c0, d0, Theta0);
